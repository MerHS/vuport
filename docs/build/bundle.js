    ...
    function create_default_slot_18(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$s, 15, 10, 616);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_15(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			p = element("p");
    			p.textContent = "Carbon is IBM’s open-source design system for digital\r\n                        products and experiences. With the IBM Design Language\r\n                        as its foundation, the system consists of working code,\r\n                        design tools and resources, human interface guidelines,\r\n                        and a vibrant community of contributors.";
    			add_location(p, file$s, 40, 22, 1665);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_12(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$s, 53, 22, 2309);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_default_slot_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$s, 64, 22, 2767);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_content_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$s, 25, 12, 928);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
